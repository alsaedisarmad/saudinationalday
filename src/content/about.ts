...
export const aboutText = {
  purpose:
    '«السعودية... حكاية وطن» معرض افتراضي بمناسبة اليوم الوطني السعودي (٢٣ سبتمبر)، يقابله معرض واقعي من الجداريات المطبوعة: رمز QR في كل جدارية يفتح صفحتها الرقمية في هذا المعرض.',
  howTo: [
